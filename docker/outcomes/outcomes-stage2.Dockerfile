...
FROM ${IMAGE_REPO_PREFIX}facsimilab-outcomes-env:${IMAGE_VERSION} AS pythonenv
...
ARG CONDA_FILE="outcomes-conda-lock.yml"
...
RUN cat /home/${MAMBA_USER}/.profile > /home/${MAMBA_USER}/.bash_aliases && \
    echo "Facsimilab-Outcomes $facsimilab_version_num" > /home/${MAMBA_USER}/.server_name.txt
...
LABEL org.opencontainers.image.title="FacsimiLab-Outcomes"
...
LABEL org.opencontainers.image.base.name="docker.io/pranavmishra90/facsimilab-outcomes-env:${IMAGE_VERSION}"
